...
{
    public class TransactionsController2 : Controller
    {
        ...
        {
            ViewBag.MoneyAccountId = new SelectList(db.MoneyAccounts, "MoneyAccountId", "UserId");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "TransactionId,UserId,MoneyAccountId,CategoryId,SubCategoryId,TransactionType,TransactionDate,Description,Amount,MoveToAccount")] Transaction transaction)
        {
            ...
            ViewBag.MoneyAccountId = new SelectList(db.MoneyAccounts, "MoneyAccountId", "UserId", transaction.MoneyAccountId);
            return View(transaction);
        }
