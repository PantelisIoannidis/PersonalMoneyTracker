...
namespace PMT.DataLayer.Seed
{
    public class SeedingLists : ISeedingLists
    {
        ...
        private void PrepareCategories()
        {
            ...
            MainCategoryList.Add(new Category { CategoryId = i++, Color= "", IconId = "icon-money-cash", Type = TransactionType.Income, Name = "Salary" });
            ...
            MainCategoryList.Add(new Category { CategoryId = i++, Color= "", IconId = "icon-moneybag", Type = TransactionType.Income, Name = "Collectin debts" });
